...
import com.ibm.swg.iseries.cache.DataQueueCache;
import com.ibm.swg.iseries.communication.BaseDataQueueFactory;

/**
 * DataQueueInNode.java, May 18, 2011, 2011
 * 
 ...
 * 
 */
public abstract class DataQueueInNode extends InputNode {
	/**
	 * 
	 */
	...
	/**
	 * The type of comparison to use to determine if a key is a match. Valid values are EQ (equal), NE (not equal), LT
	 * (less than), LE (less than or equal), GT (greater than), and GE (greater than or equal).
	 */
	protected String searchType = "EQ";
	
	/**
	 *Keylength for a keyed dataqueue
	 */
	protected int keylength = 0;

	public DataQueueInNode() throws MbException {
		super();
	...
	public void setWaitInterval(String waitInterval) {
		int value = Integer.parseInt(waitInterval);
