package com.ibm.swg.wmb.iseries.pcml.dataqueue.get;
...
public class DataQueueGetNodeUDN extends Node {
	...
	// Node constants
	protected final static String NODE_TYPE_NAME = "com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGetNode";
	protected final static String NODE_GRAPHIC_16 = "platform:/plugin/ISeriesAdapterNode/icons/full/obj16/com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet.gif";
	protected final static String NODE_GRAPHIC_32 = "platform:/plugin/ISeriesAdapterNode/icons/full/obj30/com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet.gif";
	...
	protected NodeProperty[] getNodeProperties() {
		return new NodeProperty[] {
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_CONFIGURABLESERVICE,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, "myISeries","","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_QUEUENAME,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_WAITINTERVAL,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.INTEGER, "0","","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_LIBRARY,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_TYPE,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, "DTAQ","","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_KEYED,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.BOOLEAN, "false","","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_KEY,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_KEYLENGTH,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.INTEGER, null,"","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_SEARCHTYPE,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.ENUMERATION, "EQ", ENUM_DATAQUEUEGET_SEARCHTYPE.class,"","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_ENABLE,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.BOOLEAN, "false","","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode"),
			new NodeProperty(DataQueueGetNodeUDN.PROPERTY_DIRECTORY,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/dataqueue/get/DataQueueGet",	"ISeriesAdapterNode")
		};
	}
