package com.ibm.swg.wmb.iseries.pcml.ISeriesPcmlCall;
...
public class ISeriesPcmlCallNodeUDN extends Node {
	...
	// Node constants
	protected final static String NODE_TYPE_NAME = "com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCallNode";
	protected final static String NODE_GRAPHIC_16 = "platform:/plugin/ISeriesAdapterNode/icons/full/obj16/com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall.gif";
	protected final static String NODE_GRAPHIC_32 = "platform:/plugin/ISeriesAdapterNode/icons/full/obj30/com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall.gif";
	...
	protected NodeProperty[] getNodeProperties() {
		return new NodeProperty[] {
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_CONFIGURABLESERVICE,		NodeProperty.Usage.MANDATORY,	false,	NodeProperty.Type.STRING, "myISeries","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_ISXPCML,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.BOOLEAN, "false","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_PCMLCALL,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_LIBRARYLIST,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_CCSID,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.INTEGER, "1208","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_TOPCML,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, "transformToPcml.xsl","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_TOXPCML,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, "transformToXPcml.xsl","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_FROMXPCML,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, "transformFromXPcml.xsl","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_ENABLE,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.BOOLEAN, "false","","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode"),
			new NodeProperty(ISeriesPcmlCallNodeUDN.PROPERTY_DIRECTORY,		NodeProperty.Usage.OPTIONAL,	false,	NodeProperty.Type.STRING, null,"","",	"com/ibm/swg/wmb/iseries/pcml/ISeriesPcmlCall/ISeriesPcmlCall",	"ISeriesAdapterNode")
		};
	}
